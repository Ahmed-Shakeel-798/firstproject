$(function(){
	...
	var asia_correct = new Array('answer1','answer2','answer3');
	var europe_correct = new Array('answer4','answer5','answer6');
	var americas_correct = new Array('answer7','answer8','answer9');
	...
	function score_game() {
		...
		$("#game_container .dropped").each(function(index){
			...
			if (																							// big long if statement to see if the element is in the right place
				($.inArray($thisid, europe_correct) > -1 && $parentid == 'asia') ||
				($.inArray($thisid, asia_correct) > -1 && $parentid == 'europe') ||
				($.inArray($thisid, americas_correct) > -1 && $parentid == 'americas')
			) {
